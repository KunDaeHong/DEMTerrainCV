...
public class MeshCut
{
    ...
    public static List<GameObject> cut(GameObject victim, Vector3 anchorPoint, Vector3 normalDirection, Material capMaterial, bool rightSide, bool leftSide)
    {
